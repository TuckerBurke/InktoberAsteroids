# InktoberAsteroids
## About
Inktober Asteroids is an Asteroids clone created with hand inked animated assets using Unity Engine and C#. Uses A, S, D, W for movement and SPACE to fire missles. Press ESC to return to main menu and quit. You can download the build [here](ProjectFiles/Asteroids/Builds/InktoberAsteroids.zip) if you would like to play.
## Documentation
